  ...
  return (
    ...
    >
      <div className="pt-14 wrapper">
        ...
        <p
          data-aos="fade-up"
          className="desc text-center max-w-3xl mx-auto pt-4 text-[#A4B4C3]"
        >
          Deep experience across sectors where digital products make the biggest
          difference—from property platforms to patient care and online retail.
        </p>
      </div>
      <div className="relative h-full pb-7 xl:pb-14">
